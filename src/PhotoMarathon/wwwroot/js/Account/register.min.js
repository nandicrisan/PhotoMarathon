$(document).ready(function(){$("#workshop").on("ifChanged",function(){$(this).is(":checked")?$("#workshops").css("display","block"):$("#workshops").css("display","none")});$("#workshops-select").change(function(){$("#workshops-select option:selected").data("price")==0?$("#order-data").hide():$("#order-data").show()})});
/*!
